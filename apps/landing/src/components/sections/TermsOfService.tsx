...
export default function TermsOfService() {
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      ...
      <p className="mb-4">By using PawRok, you agree to the following terms and conditions. Please read them carefully.</p>
      <h2 className="text-xl font-semibold mt-8 mb-2">Use of Service</h2>
      <ul className="list-disc ml-6 mb-4">
        <li>You must be at least 13 years old to use PawRok.</li>
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>PawRok is provided as-is without warranties.</li>
        <li>We are not liable for damages resulting from your use of the service.</li>
      </ul>
      <p className="text-gray-500 text-sm mt-8">For questions, contact us at support@pawrok.com.</p>
    </div>
  );
}
